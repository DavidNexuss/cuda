...
nvcc -O3 -Wno-deprecated-gpu-targets -gencode arch=compute_86,code=sm_86 --ptxas-options=-v   -DIMPL $@ tracer.a -lcudart -Xlinker -rpath,$CUDA_HOME/lib64 $INCLUDE_DIRS -o traceProgram -Xcompiler -fopenmp
